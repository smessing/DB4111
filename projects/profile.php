    ...
    if (!empty($id)) {
      ...
      $res = oci_fetch_row($stmt); 
        ...
        if($percentFunded < 0.15) {
          echo "<li><span><b>Percent Funded: </b></span><span><font color=\"red\">" .  number_format($percentFunded*100,2,".","") . "%</font></span></li>\n"; }
        else {
          echo "<li><span><b>Percent Funded: </b></span><span>" .  number_format($percentFunded*100,2,".","") . "%</span></li>\n"; }
